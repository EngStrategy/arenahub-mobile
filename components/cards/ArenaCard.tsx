    ...
    >
      <HStack className="items-center space-x-4">
        ...
        <VStack className="flex-1 ml-4">
          ...
          {/* Funcionamento sem ícone usando o Formatter manual (Hermes workaround) */}
          {diasFuncionamento && diasFuncionamento.length > 0 && (
            <Text className="text-sm text-green-600 mt-2 mb-1">
              {(() => {
                if (diasFuncionamento.length === 1) return diasFuncionamento[0];
                const items = [...diasFuncionamento];

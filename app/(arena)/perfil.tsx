...
import { LogOut, Lock, ChevronRight, LucideProps, Landmark } from 'lucide-react-native';
...
const MENU_ITEMS: MenuItem[] = [
    { id: 'personal-info-arena', name: 'Informações da arena', icon: Landmark, route: "/info-pessoais-arena" },
    { id: 'change-password-arena', name: 'Alterar senha', icon: Lock, route: "/alterar-senha" },
];

export default function MenuPerfilArenaScreen() {
            ...
            >
                <View className="pt-6 w-full flex-1 gap-2">
                    ...
                    <Text className="text-typography-500 mb-2">
                        Gerencie as informações da sua arena e configurações de segurança.
                    </Text>
